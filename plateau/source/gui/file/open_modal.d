...
final class OpenModal: GuiElement {
    final class DirListGui: VList {
        ...
        void add(string subDir, Color color) {
            auto btn = new TextButton(subDir);
	...
	this() {
        ...
        { //Title
            auto title = new Label("File to open:");
        ...
        { //Validation
            ...
            auto applyBtn = new TextButton("Open");
